...
void AttachmentManager::createColorResources() {
	...
	m_Image.createImageView(colorImage, colorFormat, VK_IMAGE_ASPECT_COLOR_BIT, 1, m_GPUColor);
}
...
void AttachmentManager::createDepthResources() {
	...
	m_Image.createImageView(depthImage, depthFormat, VK_IMAGE_ASPECT_DEPTH_BIT, 1, m_GPUDepth);
}
